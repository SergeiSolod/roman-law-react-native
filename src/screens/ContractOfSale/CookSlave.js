...
const CookSlave = () => {
    const task = ['Вителий предъявил иск работорговцу о расторжении договора о приобретении раба-повара, поскольку раб – весьма посредственный повар, хотя при покупке торговец хвалил раба как искусного повара.']
    const question = 'Как следует решить дело?'
    const firstAnswer = 'Вителий прав, расторгаем'
    const secondAnswer = 'Продавец прав, не расторгаем'
...
CookSlave.navigationOptions = {
    headerTitle: 'Раб повар'
}
