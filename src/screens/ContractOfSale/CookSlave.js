            ...
            <ScrollView>
                <View style={styles.textTaskWrapper}>
                    <Text style={styles.textTask}>
                        Вителий предъявил иск работорговцу о расторжении договора о приобретении раба-повара, поскольку раб – весьма посредственный повар, хотя при покупке торговец хвалил раба как искусного повара.
                    </Text>
